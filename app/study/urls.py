...
from .views import All_students_view,All_teachers_view,Course_view,CourseRetrieveUpdateView
...
urlpatterns = [
    ...
    path('courses/<int:pk>/',CourseRetrieveUpdateView.as_view(),name = 'courses'),
]
